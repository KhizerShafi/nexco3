...
//                       <li><Link href="/services#cv-sourcing" className="text-sm hover:text-orange-500">CV-Sourcing</Link></li>
//                       <li><Link href="/services#pre-qualification" className="text-sm hover:text-orange-500">Pre-Qualification</Link></li>
//                       <li><Link href="/services#lead-generation" className="text-sm hover:text-orange-500">Lead Generation</Link></li>
//                       <li><Link href="/services#cv-formatting" className="text-sm hover:text-orange-500">CV-formatting</Link></li>
//                     </ul>

//                     <h4 className="font-bold text-blue-900 mt-4 mb-2">Business Development</h4>
//                     <ul className="space-y-1">
//                       <li><Link href="/services#lead-generation" className="text-sm hover:text-orange-500">Lead Generation</Link></li>
//                       <li><Link href="/services#outreach-campaign" className="text-sm hover:text-orange-500">Outreach campaign</Link></li>
//                       <li><Link href="/services#client-support" className="text-sm hover:text-orange-500">Client relationship support</Link></li>
//                       <li><Link href="/services#proposal-assistance" className="text-sm hover:text-orange-500">Proposal and assistance</Link></li>
//                       <li><Link href="/services#admin-support" className="text-sm hover:text-orange-500">Admin support</Link></li>
//                     </ul>

//                     <h4 className="font-bold text-blue-900 mt-4 mb-2">Virtual Assistant</h4>
//                     <ul className="space-y-1">
//                       <li><Link href="/services#drc" className="text-sm hover:text-orange-500">Dedicated Recruitment Consultant</Link></li>
//                       <li><Link href="/services#dbdm" className="text-sm hover:text-orange-500">Dedicated Business Development Manager</Link></li>
//                       <li><Link href="/services#dsmm" className="text-sm hover:text-orange-500">Dedicated Social Media Manager</Link></li>
//                     </ul>
//                   </div>
//                   <div>
//                     <h4 className="font-bold text-blue-900 mb-2">Social Media Management</h4>
//                     <ul className="space-y-1">
//                       <li><Link href="/services#b2b" className="text-sm hover:text-orange-500">B2B focus and personal branding</Link></li>
//                       <li><Link href="/services#community" className="text-sm hover:text-orange-500">Community building and branding</Link></li>
//                       <li><Link href="/services#engagement" className="text-sm hover:text-orange-500">Real Time engagement</Link></li>
//                       <li><Link href="/services#content" className="text-sm hover:text-orange-500">Content creation and visual design</Link></li>
//                       <li><Link href="/services#analytics" className="text-sm hover:text-orange-500">Analytics and reporting</Link></li>
//                     </ul>

//                     <h4 className="font-bold text-blue-900 mt-4 mb-2">Web development</h4>
//                     <ul className="space-y-1">
//                       <li><Link href="/services#dev" className="text-sm hover:text-orange-500">Web development</Link></li>
//                       <li><Link href="/services#automation" className="text-sm hover:text-orange-500">Website automation</Link></li>
//                       <li><Link href="/services#ai" className="text-sm hover:text-orange-500">AI engineering</Link></li>
//                     </ul>

//                     <h4 className="font-bold text-blue-900 mt-4 mb-2">360 Recruitment</h4>
//                     <ul className="space-y-1">
//                       <li><Link href="/services#direct" className="text-sm hover:text-orange-500">Direct Recruitment</Link></li>
//                     </ul>
//                   </div>
//                 </motion.div>
//               )}
