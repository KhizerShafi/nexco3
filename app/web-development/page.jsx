      ...
      <section className="flex flex-col-reverse lg:flex-row items-center bg-white px-8 py-12 rounded-xl shadow-lg w-full max-w-[90rem] mx-auto mt-8">
        <div className="lg:w-1/2 w-full">
          <div className="flex items-center mb-5">
            ...
            <h2 className="text-3xl font-bold text-[#D3500B]">Web Development</h2>
          </div>
          ...
          <div className="flex flex-wrap gap-4">
            {[
              ...
              <span key={item} className="bg-[#FFF7F0] px-5 py-2 rounded-full text-sm font-medium text-gray-700">{item}</span>
            ))}
          </div>
        </div>
      ...
      <section className="flex flex-col lg:flex-row items-center bg-white px-8 py-12 rounded-xl shadow-lg w-full max-w-[90rem] mx-auto mt-8">
        ...
        <div className="lg:w-1/2 w-full">
          <div className="flex items-center mb-5">
            ...
            <h2 className="text-3xl font-bold text-[#D3500B]">Website Automation</h2>
          </div>
          <p className="text-gray-700 text-base leading-relaxed mb-6">
      ...
      <section className="flex flex-col-reverse lg:flex-row items-center bg-white px-8 py-12 rounded-xl shadow-lg w-full max-w-[90rem] mx-auto mt-8">
        <div className="lg:w-1/2 w-full">
          <div className="flex items-center mb-5">
            ...
            <h2 className="text-3xl font-bold text-[#D3500B]">AI Engineering</h2>
          </div>
          <p className="text-gray-700 text-base leading-relaxed mb-6">
